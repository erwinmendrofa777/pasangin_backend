...
class TukangModel extends Model
{
     ...
     * Saya sudah menambahkan kolom untuk Wallet dan Penilaian kawan.
     */
    protected $allowedFields    = [
        ...
        'specialization',
        'status',
        'balance',          // BARU: Untuk menyimpan saldo kawan
        'last_login_at',
        'fcm_token',
        'registration_step',
        'is_verify',
    ...
    // Otomatis mengisi created_at dan updated_at kawan
