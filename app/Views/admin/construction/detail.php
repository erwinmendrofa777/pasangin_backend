                ...
                <div class="tab-content pt-0 pe-1 ps-1" id="myTabContent">
                            ...
                            <div class="col-12 col-md-7 mb-4">
                                <div class="card profile-card">
                                    ...
                                    <div class="profile-body">
                                        ...
                                        <div class="gallery gallery-md mt-3">
                                            <?php
                                            $hasPhotos = false;
                                            for ($i = 1; $i <= 5; $i++) {
                                                if (!empty($construction['gambar' . $i])) {
                                                    $hasPhotos = true;
                                                    echo '<div class="gallery-item rounded shadow-sm m-1" data-image="' . base_url('uploads/construction/' . $construction['gambar' . $i]) . '" data-title="Foto Lokasi ' . $i . '" style="width: 70px; height: 70px; display: inline-block;"></div>';
                                                }
                                            }
                                            if (!$hasPhotos): ?>
                    ...
                    <?php if (can('construction_pelamar')): ?>
                        <div class="tab-pane fade" id="pelamar" role="tabpanel">
                            <?= $this->include('admin/construction/pelamar') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('construction_survey')): ?>
                        <div class="tab-pane fade" id="survey" role="tabpanel">
                            <?= $this->include('admin/construction/survey') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('construction_desain')): ?>
                        <div class="tab-pane fade" id="desain" role="tabpanel">
                            <?= $this->include('admin/construction/desain') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('construction_rab')): ?>
                        <div class="tab-pane fade" id="rab" role="tabpanel">
                            <?= $this->include('admin/construction/rab') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('construction_addendum')): ?>
                        <div class="tab-pane fade" id="addendum" role="tabpanel">
                            <?= $this->include('admin/construction/addendum') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('construction_pembayaran')): ?>
                        <div class="tab-pane fade" id="payment" role="tabpanel">
                            <?= $this->include('admin/construction/pembayaran') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('construction_progress')): ?>
                        <div class="tab-pane fade" id="progress" role="tabpanel">
                            <?= $this->include('admin/construction/progress') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('construction_progress')): ?>
                        <div class="tab-pane fade" id="info-pekerjaan" role="tabpanel">
                            <?= $this->include('admin/construction/loker') ?>
                        </div>
                    <?php endif; ?>
