        ...
        <?php else: ?>
            <div class="row g-3">
                <?php foreach ($design_list as $d):
                    ...
                    $isPdf = ($ext === 'pdf');
                    $fileUrl = base_url('uploads/construction/designs/' . $d['file']);
                    ?>
                    <div class="col-6 col-md-4 col-xl-3">
                        <div class="desain-gallery-card">
                            ...
                            <div class="desain-meta">
                                ...
                                <?php if (!empty($d['comment'])): ?>
                                    <div class="mt-1 p-2 rounded d-flex align-items-start"
                                        ...
                                        <div style="display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden; text-overflow:ellipsis;" class="text-muted font-italic">
                                            "<?= esc($d['comment']) ?>"
                                        </div>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="desain-mobile-actions">
                                ...
                                <a href="<?= base_url('admin/construction/delete-design/' . $d['id'] . '/' . $construction['id']) ?>"
                                   class="btn btn-sm btn-outline-danger ladda-button flex-grow-1"
                                   data-style="zoom-in" style="border-radius:8px; font-size:0.78rem;"
                                   onclick="if(confirm('Hapus file desain ini?')) { Ladda.create(this).start(); return true; } return false;">
