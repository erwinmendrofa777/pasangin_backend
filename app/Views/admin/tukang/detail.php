            ...
            <div class="profile-body">
                <div class="d-flex align-items-end justify-content-between mb-2">
                    <div class="avatar-wrapper">
                        <?php if (!empty($tukang['profile_photo'])): ?>
                            <img src="<?= base_url('uploads/tukang/' . $tukang['profile_photo']) ?>" alt="<?= esc($tukang['name']) ?>" class="avatar-img">
                        <?php else: ?>
                            <img src="<?= base_url('uploads/tukang/default.jpg') ?>" class="avatar-img" alt="Default Foto">
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-5 col-lg-4">
                        ...
                        <?php if (!empty($tukang['selfie_photo'])): ?>
                            <div class="position-relative">
                                <img src="<?= base_url('uploads/tukang/selfie/' . $tukang['selfie_photo']) ?>"
