...
<style>
    ...
    .badge-tukang { background: #fef3c7; color: #92400e; }
        ...
        <div class="card table-card">
            <div class="d-flex justify-content-between align-items-center px-4 py-3" style="border-bottom: 1px solid #f0f4fa;">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="<?= base_url('admin/banner/create') ?>" class="btn btn-primary d-flex align-items-center gap-2 px-3" style="border-radius: 12px; font-weight: 600;">
                    ...
                    <table class="table table-hover" id="table-1" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center align-middle">
                                ...
                                <td>
                                    <img src="<?= base_url('uploads/banners/'.$row['image']) ?>" class="banner-preview" data-toggle="tooltip" title="<?= esc($row['title']) ?>">
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('admin/banner/delete/'.$row['id']) ?>" class="btn btn-danger btn-sm ladda-button rounded-pill px-3" data-style="zoom-in" onclick="if(confirm('Yakin hapus banner ini?')) { Ladda.create(this).start(); return true; } return false;">
...
$(document).ready(function() {
    var table = $('#table-1').DataTable({
        ...
        "columnDefs": [{ "sortable": false, "targets": [1, 6] }],
        "pageLength": 10,
        "searching": true,
        "ordering": true,
        "info": true,
