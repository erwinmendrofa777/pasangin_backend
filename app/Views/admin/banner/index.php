                    ...
                    <table class="table table-striped table-md table-hover" id="table-1">
                        ...
                        <tbody class="text-center align-middle">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img alt="image" src="<?= base_url('uploads/banners/'.$row['image']) ?>" class="rounded" style="object-fit: cover; object-position: center; width:150px; height: 100px;" data-toggle="tooltip" title="<?= $row['title'] ?>">
                                </td>
                                <td><?= $row['title'] ?: '-' ?></td>
                                <td>
                                    ...
                                    <?php else: ?>
                                        <div class="badge text-white text-bg-warning">Tukang App</div>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <div class="badge my-2 badge-success">Active</div>
                                </td>
                                <td>
                                    <a href="<?= base_url('admin/banner/delete/'.$row['id']) ?>" class="btn btn-danger btn-sm ladda-button" data-style="zoom-in" onclick="if(confirm('Yakin hapus banner ini?')) { Ladda.create(this).start(); return true; } return false;">
...
$(document).ready(function() {
    ...
    var table = $('#table-1').DataTable({
        ...
        "columnDefs": [
            { "sortable": false, "targets": [1,2,3,4,5] } // Foto dan Aksi tidak bisa di-sort
        ],
        "pageLength": 10,
        "searching": true,
        "ordering": true,
