<style>
    .animate-up { animation: progFadeUp 0.4s ease both; }
    ...
    .progress-item-card:last-child { border-bottom: none; }
    ...
    .progress-item-card:hover { background: #fafbff; }
    ...
    .prog-photo-thumb:hover { transform: scale(1.1); }
    .prog-no-photo {
        width: 48px; height: 48px;
        border-radius: 10px;
        background: #f8f9fa;
    ...
    @media (max-width: 575px) {
        ...
        .target-group-header { padding: 12px 15px; }
        .target-group-header .tg-meta .tg-count-pill { display: none; }
        
        .progress-item-card { padding: 15px; }
        .progress-item-card .d-flex { flex-wrap: wrap; }
        .progress-item-card .prog-dropdown { width: 100%; margin-top: 12px; }
        .progress-item-card .prog-status-pill { width: 100%; justify-content: center; }
        
        .prog-num { display: none; } /* Hide number on mobile to save space */
    }
                ...
                <div class="progress-item-card <?= $stClass ?>">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <?php if (!empty($app['photo'])): ?>
                            <a href="<?= base_url('uploads/progress/' . $app['photo']) ?>" target="_blank">
                                <img src="<?= base_url('uploads/progress/' . $app['photo']) ?>" class="prog-photo-thumb" alt="Foto Progress">
                            </a>
                        <?php else: ?>
