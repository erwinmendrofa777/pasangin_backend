                ...
                <div class="tab-content pt-0 pe-1 ps-1" id="myTabContent">
                                        ...
                                        <div class="gallery gallery-md mt-3">
                                            ...
                                            for ($i = 1; $i <= 5; $i++) {
                                                if (!empty($renovation['gambar' . $i])) {
                                                    $hasPhotos = true;
                                                    echo '<div class="gallery-item rounded shadow-sm m-1" data-image="' . base_url('uploads/renovation/' . $renovation['gambar' . $i]) . '" data-title="Foto Lokasi ' . $i . '" style="width: 70px; height: 70px; display: inline-block;"></div>';
                                                }
                                            }
                                            if (!$hasPhotos): ?>
                    ...
                    <?php if (can('renovation_target')): ?>
                        <div class="tab-pane fade" id="target" role="tabpanel">
                            <?= $this->include('admin/renovation/target') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('renovation_survey')): ?>
                        <div class="tab-pane fade" id="survey" role="tabpanel">
                            <?= $this->include('admin/renovation/survey') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('renovation_desain')): ?>
                        <div class="tab-pane fade" id="desain" role="tabpanel">
                            <?= $this->include('admin/renovation/desain') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('renovation_rab')): ?>
                        <div class="tab-pane fade" id="rab" role="tabpanel">
                            <?= $this->include('admin/renovation/rab') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('renovation_pembayaran')): ?>
                        <div class="tab-pane fade" id="payment" role="tabpanel">
                            <?= $this->include('admin/renovation/pembayaran') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('renovation_progress')): ?>
                        <div class="tab-pane fade" id="progress" role="tabpanel">
                            <?= $this->include('admin/renovation/progress') ?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (can('renovation_progress')): ?>
                        <div class="tab-pane fade" id="info-pekerjaan" role="tabpanel">
                            <?= $this->include('admin/renovation/loker') ?>
                        </div>
                    <?php endif; ?>
