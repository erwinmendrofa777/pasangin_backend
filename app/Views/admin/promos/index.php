...
<?= $this->section('title') ?> Kelola Promo Supplier <?= $this->endSection() ?>
<?= $this->section('page_title') ?> Promo Supplier <?= $this->endSection() ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if (strpos($row['photo'], 'http') === 0): ?>
                                        <a class="image-link">
                                            <img src="<?= $row['photo'] ?>" class="rounded my-2" style="object-fit: cover; object-position: center; width:100px; height: 100px;" data-toggle="tooltip" title="<?= esc($row['title']) ?>">
                                        </a>
                                    <?php elseif(empty($row['photo'])): ?>
                                        GAMBAR KOSONG
                                    <?php else : ?>
                                        <img alt="image" src="<?= base_url('uploads/promos/'.$row['photo']) ?>" class="rounded my-2" style="object-fit: cover; object-position: center; width:100px; height: 100px;" data-toggle="tooltip" title="<?= esc($row['title']) ?>">
                                    <?php endif; ?>
                                    <!-- gambar end -->
                                </td>
                                ...
                                <td>
                                    <a href="<?= base_url('admin/promo/detail/'.$row['id']) ?>" class="btn btn-info btn-sm" data-toggle="tooltip" title="Detail"><i class="fas fa-eye"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
