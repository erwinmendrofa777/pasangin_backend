    ...
    <div class="col-12">
        ...
        <div class="card shadow">
            <div class="card-header">
                <h4>Riwayat Notifikasi Terkirim</h4>
                <div class="card-header-action d-flex gap-2">
                    ...
                    <a href="<?= base_url('admin/notification/create') ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Kirim Notifikasi Baru</a>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-md table-hover" id="table-1">
                        <thead class="text-center">
                            <tr>
                                <th style="width:25%" class="text-center">Waktu</th>
                                <th style="width:15%" class="text-center">Target</th>
                                <th style="width:25%" class="text-center">Judul</th>
                                <th style="width:30%" class="text-center">Pesan</th>
                            </tr>
                        </thead>
                        <tbody class="text-center align-middle">
                            ...
                            <tr>
                                ...
                                <td><span class="badge my-2 badge-info"><?= strtoupper($n['target_type']) ?></span></td>
...
$(document).ready(function() {
    ...
    var table = $('#table-1').DataTable({
        ...
        "columnDefs": [
            { "sortable": false, "targets": [1,2,3] } // Foto dan Aksi tidak bisa di-sort
        ],
        "pageLength": 10,
        "searching": true,
        "ordering": true,
