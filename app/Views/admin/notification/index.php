        ...
        <div class="card shadow-sm table-card">
            <div class="card-header d-flex justify-content-between align-items-center bg-white border-0 py-3 px-4">
                <div class="search-wrapper">
                    ...
                    <input type="text" class="form-control" id="searchInput" placeholder="Ketik untuk mencari notifikasi">
                </div>
                <?php if (can('notification_create')): ?>
                <a href="<?= base_url('admin/notification/create') ?>" class="btn btn-primary px-4 py-2 fw-bold" style="border-radius: 12px; box-shadow: 0 4px 12px rgba(103, 119, 239, 0.35); height: 44px; display: flex; align-items: center;">
                                ...
                                <tr>
                                    <td>
                                        <div class="notif-time">
                                            ...
                                            <?= date('d M Y', strtotime($n['created_at'])) ?> <?= date('H:i', strtotime($n['created_at'])) ?> WIB
                                        </div>
                                    </td>
                                    <td>
