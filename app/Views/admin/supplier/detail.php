        ...
        <div class="card shadow-sm profile-card">
            ...
            <div class="profile-body">
                ...
                <div class="d-flex align-items-end justify-content-between mb-3">
                    <div class="avatar-wrapper">
                        <?php if ($supplier['logo_url']): ?>
                            <img src="<?= base_url('uploads/supplier/' . $supplier['logo_url']) ?>"
                                alt="<?= esc($supplier['name']) ?>" class="avatar-img" id="img-preview">
                        <?php else: ?>
                ...
                <div class="info-list">
                    ...
                    <!-- ===== GOOGLE MAPS EMBED ===== -->
                    <div class="mt-4">
                        <p class="section-title mb-2"><i class="fas fa-map-marked-alt me-1"></i>Peta Lokasi Geografis (Gmaps)</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius:14px; border:none; box-shadow:0 16px 48px rgba(0,0,0,0.18);">
            ...
            <div class="modal-footer border-0 justify-content-center gap-2 pt-0 pb-4">
                ...
                <a href="<?= base_url('admin/suppliers/delete/' . $supplier['id']) ?>" class="btn btn-danger px-4 fw-semibold" style="border-radius:8px;">
