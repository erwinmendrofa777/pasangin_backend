...
<form id="create-supplier-form" method="POST" action="<?= base_url('admin/suppliers/save') ?>" enctype="multipart/form-data">
    <?= csrf_field() ?>
                ...
                <div class="edit-body pb-0">
                    ...
                    <div class="d-flex align-items-end justify-content-between mb-2">
                        <div class="avatar-wrapper position-relative">
                            <div class="avatar-initials d-flex" id="img-preview-initials"><i class="fas fa-building" style="font-size: 1.5rem;"></i></div>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" id="is_active" name="is_active">
                                            <option value="1" <?= set_value('is_active') == '1' ? 'selected' : '' ?>>Tampil (Aktif)</option>
                                            <option value="0" <?= set_value('is_active') == '0' ? 'selected' : '' ?>>Sembunyikan (Non-Aktif)</option>
                                        </select>
                                    </div>
                                </div>
