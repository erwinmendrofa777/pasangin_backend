            ...
            <div class="tab-content" id="myTabContent">
                ...
                <?php if (can('design_survey')): ?>
                    <div class="tab-pane fade" id="survey" role="tabpanel">
                        <!-- included file -->
                        <?= $this->include('admin/design/survey') ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if (can('design_desain')): ?>
                    <div class="tab-pane fade" id="design" role="tabpanel">
                        <!-- included file -->
                        <?= $this->include('admin/design/desain') ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if (can('design_target')): ?>
                    <div class="tab-pane fade" id="target" role="tabpanel">
                        <!-- included file -->
                        <?= $this->include('admin/design/target') ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if (can('design_progress')): ?>
                    <div class="tab-pane fade" id="progress" role="tabpanel">
                        <!-- included file -->
                        <?= $this->include('admin/design/progress') ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if (can('design_pembayaran')): ?>
                    <div class="tab-pane fade" id="payment" role="tabpanel">
                        <!-- included file -->
                        <?= $this->include('admin/design/pembayaran') ?>
                    </div>
                <?php endif; ?>
