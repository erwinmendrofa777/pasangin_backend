                    ...
                    foreach ($targets as $idx => $t): ?>
                        ...
                        <tr class="item-row text-center">
                            ...
                            <td class="text-start ps-2">
                                <span class="fw-semibold" style="font-size:13px;"><?= esc($t['task_name']) ?></span><br>
                                <?php if (!empty($t['keterangan'])): ?>
                                    <small class="text-muted"><?= esc($t['keterangan']) ?></small>
                                <?php endif; ?>
                            </td>
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3 pt-3"
                            ...
                            <div class="d-flex flex-column gap-1">
                                ...
                                ?>
                                <div class="text-white fw-bold bg-primary px-3 py-1 rounded-pill d-inline-block text-center" style="font-size: 0.8rem; width: fit-content;">
                                    <i class="fas fa-stopwatch me-1"></i> Durasi: <?= $targetDuration ?> Hari
                                </div>
                                <?php if ($targetStartDateStr): ?>
                                <div class="text-muted mt-1" style="font-size: 0.8rem;">
                                    <i class="fas fa-calendar-alt me-1"></i> <?= $targetStartDateStr ?> s/d <?= $targetEndDateStr ?>
                                </div>
                                <?php endif; ?>
                            </div>
                            <a href="<?= base_url('admin/design/delete-target/' . $t['id'] . '/' . $request['id']) ?>"
