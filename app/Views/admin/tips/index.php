                    ...
                    <table class="table table-striped table-md table-hover" id="table-1">
                        <thead class="text-center">
                            <tr>
                                ...
                                <th class="text-center">Judul & Target</th>
                        ...
                        <tbody class="text-center align-middle">
                            ...
                            <tr>
                                <td><?= $key + 1 ?></td>
                                <td>
                                    <img src="<?= base_url('uploads/tips/'.$row['image']) ?>" class="rounded my-2" style="object-fit: cover; object-position: center; width:150px; height: 100px;" data-toggle="tooltip" title="<?= $row['title'] ?>">
                                </td>
                                <td>
                                    ...
                                    <?php else: ?>
                                        <div class="badge text-white text-bg-warning mt-1">Tukang</div>
                                    <?php endif; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="<?= base_url('admin/tips/delete/'.$row['id']) ?>" class="btn btn-danger btn-sm ladda-button" data-style="zoom-in" onclick="if(confirm('Hapus?')) { Ladda.create(this).start(); return true; } return false;">
...
$(document).ready(function() {
    ...
    var table = $('#table-1').DataTable({
        ...
        "columnDefs": [
            { "sortable": false, "targets": [1,2,3,4] } // Foto dan Aksi tidak bisa di-sort
        ],
        "pageLength": 10,
        "searching": true,
        "ordering": true,
