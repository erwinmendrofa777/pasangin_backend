...
<body>
    ...
    <table class="tabel-layout mb-2">
        ...
        <tr>
            <td>Proyek</td>
            <td>:</td>
            <td>Proyek #<?= $template_kontrak['renovation_id'] ?></td>
        </tr>
        <tr>
            <td>Lokasi</td>
            <td>:</td>
            <td><?= $template_kontrak['address_renovation'] ?></td>
        </tr>
    </table>
    ...
    <p class="text-center">Disetujui bersama,<br><?= $template_kontrak['address_renovation'] ?>, <?= tanggal_indo($tanggal_kontrak) ?></p>
