                    ...
                    <div class="row g-4">
                        <div class="col-12 col-md-6">
                            ...
                            <select name="target_app" class="form-select form-control-custom <?= session('errors.target_app') ? 'is-invalid' : '' ?>" required>
                                ...
                                <option value="CLIENT" <?= old('target_app') == 'CLIENT' ? 'selected' : '' ?>>Aplikasi Client</option>
                                <option value="TUKANG" <?= old('target_app') == 'TUKANG' ? 'selected' : '' ?>>Aplikasi Tukang (Mitra)</option>
                                <option value="SUPPLIER" <?= old('target_app') == 'SUPPLIER' ? 'selected' : '' ?>>Aplikasi Supplier</option>
                                <option value="PROYEK" <?= old('target_app') == 'PROYEK' ? 'selected' : '' ?>>Manajemen Proyek</option>
                            </select>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="title" class="form-control form-control-custom <?= session('errors.title') ? 'is-invalid' : '' ?>" value="<?= old('title') ?>" placeholder="E.g. Kebijakan Privasi Client" required>
