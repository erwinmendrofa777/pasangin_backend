                ...
                <tbody>
                    <?php foreach ($products as $key => $row): ?>
                        <tr class="text-center align-middle">
                            ...
                            <td>
                                <?php if (!empty($row['photo']) && file_exists('./uploads/products/' . $row['photo'])): ?>
                                    <img src="<?= base_url('uploads/products/' . $row['photo']) ?>" class="product-img"
                                        data-toggle="tooltip" title="<?= esc($row['name']) ?>">
                                <?php elseif (strpos($row['photo'], 'http') === 0): ?>
                                    <img src="<?= $row['photo'] ?>" class="product-img"
                                        data-toggle="tooltip" title="<?= esc($row['name']) ?>">
                                <?php else: ?>
                                    <div class="product-img d-flex align-items-center justify-content-center bg-light text-muted" style="margin: 0 auto;">
                            ...
                            <td>
                                <?php if ($row['status'] === 'aktif' && $row['stock'] > 0): ?>
                                    <span class="status-badge status-available"><i class="fas fa-check-circle"></i> Tersedia</span>
