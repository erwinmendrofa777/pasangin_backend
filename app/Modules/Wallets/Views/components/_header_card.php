        ...
        <div class="row align-items-center g-3">
            <div class="col-lg-6">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1 fw-bold text-dark" style="letter-spacing: -0.3px;">Saldo Mitra Tukang</h5>
                        <p class="text-muted mb-0 small">Daftar, cari, dan kelola saldo serta penarikan dana mitra tukang Pasangin.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="d-flex align-items-center justify-content-lg-end gap-2 flex-wrap flex-sm-nowrap">
                    ...
                    <div class="search-wrapper" style="width: 240px; max-width: 100%;">
                        <input type="text" class="search-input w-100" id="searchInput" placeholder="Cari nama, No HP..." style="padding-left: 38px !important;">
                    ...
                    <?php if (can('wallet_withdraw_request')): ?>
                        <a href="<?= base_url('admin/wallet/withdrawals') ?>"
                            ...
                            style="border-radius: 10px; font-size: 0.82rem; height: 40px; padding: 0 16px; white-space: nowrap; font-weight: 600; color: #fff;">
