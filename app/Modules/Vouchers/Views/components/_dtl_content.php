            ...
            <div class="detail-body">
                ...
                <div class="d-flex align-items-end justify-content-between">
                    <div class="voucher-preview-wrapper">
                        <a href="<?= base_url('uploads/vouchers/' . $voucher['image']) ?>" class="glightbox"
                            data-title="<?= esc($voucher['name']) ?>"
                            data-description="Kode: <?= esc($voucher['code']) ?> | Potongan: Rp <?= number_format($voucher['discount_nominal'], 0, ',', '.') ?>">
                            <img src="<?= base_url('uploads/vouchers/' . $voucher['image']) ?>" alt="Voucher Visual"
                                class="voucher-preview-img" style="cursor:pointer;">
                        </a>
                    </div>
                    <div class="text-end">
                        <span class="text-muted" style="font-size: 0.75rem;">
                            Dibuat Pada: <br><strong><?= date('d M Y, H:i', strtotime($voucher['created_at'])) ?>
                                WIB</strong>
                        </span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="text-primary fw-bold small text-uppercase mb-3" style="letter-spacing: 1px;">Detail
                            Voucher</p>
                        <div class="info-list">
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <div>
                                    ...
                                    <div class="info-value text-success">Rp
                                        <?= number_format($voucher['discount_nominal'], 0, ',', '.') ?></div>
                                </div>
                            </div>
                            <div class="info-item">
                                ...
                                <div>
                                    ...
                                    <div class="info-value"><?= date('d F Y', strtotime($voucher['valid_until'])) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <p class="text-primary fw-bold small text-uppercase mb-3" style="letter-spacing: 1px;">Kode
                            &amp; Deskripsi</p>
                ...
                <div class="card-body pt-0">
                    <div class="d-grid gap-2">
                        <a href="<?= base_url('admin/vouchers/update-status/' . $voucher['id'] . '/1') ?>"
                            ...
                            <?= $voucher['is_active'] == 1 ? 'Voucher Aktif' : 'Aktifkan' ?>
                        </a>
                        <a href="<?= base_url('admin/vouchers/update-status/' . $voucher['id'] . '/0') ?>"
                            ...
                            <?= $voucher['is_active'] == 0 ? 'Voucher Nonaktif' : 'Nonaktifkan' ?>
                        </a>
                    </div>
            ...
            <div class="card detail-card shadow-sm">
                ...
                <div class="card-body pt-0">
                    <div class="d-grid gap-3">
                        <button type="button" class="btn btn-outline-danger py-2 fw-bold" style="border-radius: 12px;"
        ...
        <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 10px 40px rgba(0,0,0,0.2);">
            <div class="modal-body text-center p-5">
                ...
                <p class="text-muted mb-4">
                    Anda akan menghapus voucher <strong><?= esc($voucher['name']) ?></strong>. Tindakan ini tidak dapat
                    dibatalkan.
                </p>
                <div class="d-flex justify-content-center gap-3">
                    <button type="button" class="btn btn-light px-4 fw-bold" data-bs-dismiss="modal"
                        style="border-radius: 10px;">Batal</button>
                    <a href="<?= base_url('admin/vouchers/delete/' . $voucher['id']) ?>"
                        class="btn btn-danger px-4 fw-bold" style="border-radius: 10px;">Ya, Hapus</a>
                </div>
            </div>
        </div>
    </div>
