...
use App\Modules\Supplier\Services\PromoService;
...
class PromoController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('App\Modules\Supplier\Views\promos/index', array_merge($result, ['title' => 'Manajemen Promo']));
    }
    ...
    public function detail($id = null)
    {
        ...
        try {
            ...
            return view('App\Modules\Supplier\Views\promos/detail', ['title' => 'Detail Promo', 'promo' => $promo]);
    ...
    public function update_status($id, $status)
    {
        ...
        log_admin_activity('update_status', 'promo', 'Ubah status promo dengan id: ' . $id);
    ...
    public function delete($id)
    {
        ...
        log_admin_activity('delete', 'promo', 'Hapus promo dengan id: ' . $id);
