      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              ...
              <img alt="image" src="https://cdn.jsdelivr.net/npm/stisla@2.3.0/assets/img/avatar/avatar-1.png"
                class="rounded-circle mr-1">
              <div class="d-sm-none d-lg-inline-block">Hi, <?= esc(session()->get('supplier_name')) ?></div>
            </a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= site_url('supplier/dashboard') ?>" class="d-flex align-items-center justify-content-center">
              <img src="<?= base_url('assets/img/p-50.png') ?>" alt="Logo" style="width: 32px; height: 32px; object-fit: contain; margin-right: 8px;">
              <span>Pasangin.co.id</span>
            </a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?= site_url('supplier/dashboard') ?>" class="d-flex align-items-center justify-content-center" style="height: 60px;">
              <img src="<?= base_url('assets/img/p-50.png') ?>" alt="Logo" style="width: 30px; height: 30px; object-fit: contain;">
            </a>
          </div>
