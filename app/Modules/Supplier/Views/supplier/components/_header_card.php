        ...
        <div class="row align-items-center g-3">
            <div class="col-lg-6">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1 fw-bold text-dark" style="letter-spacing: -0.3px;">Kelola Supplier</h5>
                        <p class="text-muted mb-0 small">Daftar, cari, dan kelola profil mitra supplier Pasangin.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
