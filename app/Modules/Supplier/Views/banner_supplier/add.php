...
<?= $this->include('App\Modules\Supplier\Views\banner_supplier\components\_add_form') ?>
<?= $this->endSection() ?>

<?= $this->section('script') ?>
<?= $this->include('App\Modules\Supplier\Views\banner_supplier\components\_add_scripts') ?>
<?= $this->endSection() ?>