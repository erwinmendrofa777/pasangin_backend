                    ...
                    <div class="d-flex justify-content-between align-items-center position-relative" style="z-index:1;">
                        <div>
                            <h5 class="text-white mb-1 fw-bold" style="font-size:1.15rem;">
                                Buat Banner Supplier
                            </h5>
                            <p class="text-white-50 small mb-0">Lengkapi formulir untuk mempublikasikan banner mitra</p>
                        </div>
                        <span class="badge bg-white text-primary px-3 py-2 d-none d-sm-inline-block" style="border-radius:50px; font-size:0.75rem; font-weight:700;">
                            <i class="fas fa-image me-1 opacity-75"></i>BARU
                        </span>
                    </div>
                </div>
                            ...
                            <div class="text-center mb-4">
                                <div class="avatar-wrapper mx-auto">
                                    <div class="banner-placeholder" id="img-preview-placeholder">
                                        ...
                                        <span style="font-size: 0.75rem; font-weight: 700; opacity: 0.8;">PRATINJAU BANNER</span>
                                    </div>
                                ...
                                <div class="mt-3">
                                    <p class="small text-muted">Rekomendasi ukuran: 1200 x 600 px (Maks. 3MB)</p>
                            ...
                            <div class="card section-card mb-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <textarea name="note" class="form-control" rows="3" placeholder="Tambahkan catatan khusus jika ada..."><?= old('note') ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 justify-content-center">
                                <div class="col-6">
                                    <button type="submit" class="btn btn-save w-100 ladda-button" data-style="zoom-out">
                                        <span class="ladda-label"><i class="fas fa-save me-2"></i>Simpan Banner</span>
                                    </button>
                                </div>
                            </div>
