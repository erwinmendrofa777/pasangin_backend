                                            ...
                                            <?php if (!empty($srv['file_url'])): ?>
                                                ...
                                                <?php if ($isPdf): ?>
                                                    <a href="<?= $fileUrl ?>" target="_blank"
                                                        class="flex-shrink-0 bg-danger bg-opacity-10 text-danger rounded-3 d-flex align-items-center justify-content-center"
                                                        style="width: 48px; height: 48px; font-size: 1.25rem; text-decoration:none; border: 1px solid rgba(220,53,69,0.2);"
                                                        title="Lihat PDF">
                                                ...
                                                <?php elseif ($isImage): ?>
                                                    <div class="flex-shrink-0 bg-success bg-opacity-10 text-success rounded-3 d-flex align-items-center justify-content-center"
                                                        style="width: 48px; height: 48px; font-size: 1.25rem; cursor:pointer;"
                                                        onclick="$('#glb-renovation-survey-img-<?= $srv['id'] ?>').click();">
                                                        <i class="fas fa-file-image"></i>
                                                    </div>
                                                <?php elseif ($isVideo): ?>
                                                    <div class="flex-shrink-0 bg-warning bg-opacity-10 text-warning rounded-3 d-flex align-items-center justify-content-center position-relative"
                                                        style="width: 48px; height: 48px; font-size: 1.25rem; cursor:pointer;"
