        ...
        <div class="row align-items-center g-3">
            <div class="col-lg-5">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1 fw-bold text-dark" style="letter-spacing: -0.3px;">Manajemen Proyek Renovasi</h5>
                        <p class="text-muted mb-0 small">Pantau progress, kelola RAB, desain, survey, dan status proyek renovasi client.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="d-flex align-items-center justify-content-lg-end gap-2 flex-wrap flex-sm-nowrap">
                    ...
                    <a href="<?= base_url('admin/renovation/export-pdf') ?>" class="btn-export-pdf w-100 w-sm-auto" target="_blank">
                    ...
                    <div class="search-wrapper w-100 w-sm-auto" style="min-width: 240px;">
                        <input type="text" class="search-input w-100" id="searchInput" placeholder="Cari pelanggan, tipe..." style="padding-left: 38px !important;">
