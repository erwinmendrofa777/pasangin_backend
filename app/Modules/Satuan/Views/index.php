...
<style>
    ...
    #table-satuan thead tr {
        background: var(--palette-primary) !important;
    }

    #table-satuan thead th {
    ...
    #table-satuan thead th:first-child {
        border-top-left-radius: 16px !important;
    }

    #table-satuan thead th:last-child {
        border-top-right-radius: 16px !important;
    }

    #table-satuan tbody tr:last-child td:first-child {
        border-bottom-left-radius: 16px !important;
    }

    #table-satuan tbody tr:last-child td:last-child {
        border-bottom-right-radius: 16px !important;
    }

    #table-satuan tbody tr {
...
?>
<?= $this->include('App\Modules\Satuan\Views\components\_header_card') ?>
<?= $this->include('App\Modules\Satuan\Views\components\_idx_content') ?>
<?= $this->include('App\Modules\Satuan\Views\components\_form_modal', ['validationErrors' => $validationErrors, 'error' => $error]) ?>
<?= $this->endSection() ?>

<?= $this->section('script') ?>
<?= $this->include('App\Modules\Satuan\Views\components\_idx_scripts', ['validationErrors' => $validationErrors, 'error' => $error, 'success' => $success]) ?>
<?= $this->endSection() ?>
