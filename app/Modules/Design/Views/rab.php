    ...
    <div class="rab-panel-header">
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 w-100">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1 fw-bold text-dark" style="letter-spacing: -0.3px; font-size: 1.1rem; margin-bottom: 2px !important;">Manajemen RAB Desain</h5>
                    <p class="text-muted mb-0 small" style="font-size: 0.82rem;">Kelola data rencana anggaran biaya (RAB) untuk proyek desain ini.</p>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-4 text-center">
                    ...
                    <a href="<?= base_url('admin/design/download-rab-template/' . $request['id']) ?>"
