    ...
    <div class="card-body p-4">
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1 fw-bold text-dark" style="letter-spacing: -0.3px;">Manajemen RAB Desain</h5>
                    <p class="text-muted mb-0 small">Kelola data rencana anggaran biaya (RAB) untuk proyek desain ini.</p>
                </div>
            </div>
