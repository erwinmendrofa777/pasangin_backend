...
<?= $this->section('title') ?>Tambah Role<?= $this->endSection() ?>
<?= $this->section('page_title') ?>Tambah Role<?= $this->endSection() ?>
...
<div class="cr-wrapper">
    <?= $this->include('App\Modules\Admin\Views\roles\components\_create_form') ?>
</div>
<?= $this->endSection() ?>

<?= $this->section('script') ?>
<?= $this->include('App\Modules\Admin\Views\roles\components\_create_scripts') ?>
<?= $this->endSection() ?>