...
class RoleController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('App\Modules\Admin\Views\roles/index', [
            'title' => 'Kelola Role',
    ...
    public function create()
    {
        ...
        return view('App\Modules\Admin\Views\roles/create', [
            'title' => 'Tambah Role',
    ...
    public function store()
    {
        ...
        try {
            ...
            log_admin_activity('create', 'roles', 'menambahkan role');
    ...
    public function edit($id)
    {
        ...
        try {
            return view('App\Modules\Admin\Views\roles/edit', [
                'title' => 'Edit Role',
    ...
    public function update($id)
    {
        ...
        try {
            ...
            log_admin_activity('update', 'roles', 'mengupdate role');
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            log_admin_activity('delete', 'roles', 'menghapus role');
