...
namespace App\Modules\PriceEstimate\Controllers\Admin;

use App\Controllers\BaseController;
use App\Modules\PriceEstimate\Services\PriceEstimateService;
...
class PriceEstimateController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('App\Modules\PriceEstimate\Views\index', array_merge($data, [
    ...
    public function storeConcept()
    {
        ...
        try {
            ...
            log_admin_activity('create', 'estimasi harga', 'Tambah Konsep');
    ...
    public function updateConcept($id)
    {
        ...
        try {
            ...
            log_admin_activity('update', 'estimasi harga', 'Update Konsep dengan id: ' . $id);
    ...
    public function deleteConcept($id)
    {
        ...
        try {
            ...
            log_admin_activity('delete', 'estimasi harga', 'Hapus Konsep dengan id: ' . $id);
    ...
    public function storeQuality()
    {
        ...
        try {
            ...
            log_admin_activity('create', 'estimasi harga', 'Tambah kualitas');
    ...
    public function updateQuality($id)
    {
        ...
        try {
            ...
            log_admin_activity('update', 'estimasi harga', 'Update kualitas');
    ...
    public function deleteQuality($id)
    {
        ...
        try {
            ...
            log_admin_activity('delete', 'estimasi harga', 'Hapus kualitas dengan ID: ' . $id);
