...
class ConstructionProgressRepository implements ConstructionProgressRepositoryInterface
{
    ...
    {
        return $this->model
            ->select('construction_progress.id, construction_progress.id_construction_targets, construction_progress.bobot, construction_progress.description as keterangan, construction_progress.status, construction_progress.photo_url as photo, construction_progress.created_at, ct.id_construction_rabs, ct.id_construction_addendum, cr.group_name as rab_group_name, cr.sub_group_name as rab_sub_group_name, cr.activity_name as rab_activity_name, ca.group_name as addendum_group_name, ca.sub_group_name as addendum_sub_group_name, ca.activity_name as addendum_activity_name')
