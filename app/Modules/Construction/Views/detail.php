                ...
                <div class="nav-tabs-wrapper">
                    ...
                    <ul class="nav nav-tabs nav-tabs-premium" id="myTab" role="tablist">
                        ...
                        <?php if (can('construction_pelamar')): ?>
                            <li class="nav-item"><a class="nav-link text-success" data-bs-toggle="tab" href="#pelamar"><i
                                        class="fas fa-users-cog"></i> Pelamar</a></li>
                        <?php endif; ?>
                        ...
                        <?php if (can('construction_addendum')): ?>
                            <li class="nav-item"><a class="nav-link text-primary" data-bs-toggle="tab" href="#addendum"><i
                                        class="fas fa-file-signature"></i> Addendum</a></li>
                        <?php endif; ?>
                        ...
                        <?php if (can('construction_absensi')): ?>
                            <li class="nav-item"><a class="nav-link text-primary" data-bs-toggle="tab" href="#absensi"><i
                                        class="fas fa-user-check"></i> Absensi</a></li>
                        <?php endif; ?>

                        <?php if (can('construction')): ?>
                            <li class="nav-item"><a class="nav-link text-primary" data-bs-toggle="tab" href="#material"><i
                                        class="fas fa-box-open"></i> Pengajuan Material</a></li>
                        <?php endif; ?>
