        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 w-100">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <small class="text-white opacity-75">Riwayat kehadiran pekerja konstruksi</small>
                </div>
            </div>
                            ...
                            <tr>
                                    ...
                                    <?php if (!empty($abs['file'])): ?>
                                        ...
                                        <div style="display:none;" id="video-absen-<?= $abs['id'] ?>">
                                            <div class="p-3 text-center" style="background:#000; border-radius:12px; max-width:800px; margin:0 auto;">
                                                <video src="<?= base_url('uploads/construction/absen_tukang/' . $abs['file']) ?>" controls style="width:100%; max-height:60vh; border-radius:8px; display:block;" preload="metadata" playsinline></video>
                                                <div class="text-white mt-2 text-start px-2">
                                                    <h6 class="mb-1 fw-bold text-white">Bukti Video Absen <?= $abs['type'] === 'masuk' ? 'Masuk' : 'Keluar' ?></h6>
                                                    <small class="text-muted">Waktu Absen: <?= date('d M Y, H:i:s', strtotime($abs['waktu'])) ?> WIB</small>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <td class="text-center pe-4">
                                    <button type="button" class="btn btn-sm btn-outline-danger"
                                        onclick="confirmDeleteAttendance(<?= $abs['id'] ?>, <?= $construction['id'] ?>)"
                                        title="Hapus Absensi"
