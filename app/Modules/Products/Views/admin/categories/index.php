...
<style>
    ...
    #table-categories thead th:last-child {
        border-top-right-radius: 16px !important;
    }

    #table-categories tbody tr:last-child td:first-child {
        border-bottom-left-radius: 16px !important;
    }

    #table-categories tbody tr:last-child td:last-child {
...
?>
<?= $this->include('App\Modules\Products\Views\admin\categories\components\_header_card') ?>
<?= $this->include('App\Modules\Products\Views\admin\categories\components\_idx_content') ?>
<?= $this->include('App\Modules\Products\Views\admin\categories\components\_form_modal', ['validationErrors' => $validationErrors, 'error' => $error]) ?>
<?= $this->endSection() ?>

<?= $this->section('script') ?>
<?= $this->include('App\Modules\Products\Views\admin\categories\components\_idx_scripts', ['validationErrors' => $validationErrors, 'error' => $error, 'success' => $success]) ?>
<?= $this->endSection() ?>
