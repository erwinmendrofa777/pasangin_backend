...
<?= $this->section('content') ?>
    <?= $this->include('App\Modules\Products\Views\components\_header_card') ?>
    <?= $this->include('App\Modules\Products\Views\components\_idx_table') ?>
<?= $this->endSection() ?>

<?= $this->section('script') ?>
    <?= $this->include('App\Modules\Products\Views\components\_idx_scripts') ?>
<?= $this->endSection() ?>