        ...
        <div class="row align-items-center g-3">
            <div class="col-lg-6">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1 fw-bold text-dark" style="letter-spacing: -0.3px;">Kelola Produk</h5>
                        <p class="text-muted mb-0 small">Daftar, cari, dan kelola ketersediaan katalog produk Pasangin.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-lg-end gap-2 flex-wrap flex-sm-nowrap">
                    ...
                    <div class="search-wrapper" style="width: 400px; max-width: 100%;">
                        <input type="text" class="search-input w-100" id="searchInput"
                            placeholder="Cari nama produk, supplier..." style="padding-left: 38px !important;">
