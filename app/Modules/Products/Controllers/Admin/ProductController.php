 ...
 * Semua itu ada di App\Modules\Products\Services\ProductService.
 */
class ProductController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('App\Modules\Products\Views\index', [
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            log_admin_activity('delete', 'product', 'Hapus produk dengan id: ' . $id);
